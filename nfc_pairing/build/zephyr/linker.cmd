...
nfc_tnep_tag_service_area : SUBALIGN(4) { _nfc_tnep_tag_service_list_start = .; KEEP(*(SORT_BY_NAME(._nfc_tnep_tag_service.static.*))); _nfc_tnep_tag_service_list_end = .; } > FLASH
/DISCARD/ :
{
 KEEP(*(.irq_info*))
 KEEP(*(.intList*))
