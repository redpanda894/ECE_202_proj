...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SCAN_OFFLOAD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SCAN_SELF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SCAN_DELAY, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TARGET_BROADCAST_NAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ENABLE_LC3, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_BROADCAST_SNK_SUBGROUP_COUNT, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_BROADCAST_SNK_COUNT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_BAP_SCAN_DELEGATOR_MAX_SUBGROUPS, 2);
